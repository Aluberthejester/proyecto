        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('artists.index')"
                        :active="request()->routeIs('artists.index')">
                        {{ __('Artists') }}
                    </x-nav-link>

                    <x-nav-link :href="route('albums.index')"
                        :active="request()->routeIs('albums.index')">
                        {{ __('Albums') }}
                    </x-nav-link>

                    <x-nav-link :href="route('songs.index')"
                        :active="request()->routeIs('songs.index')">
                        {{ __('Songs') }}
                    </x-nav-link>
                </div>
            </div>
